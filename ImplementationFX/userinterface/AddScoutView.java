...
public class AddScoutView extends View {
    ...
    private Node createTitle() {
        ...
        Text titleText = new Text("Add New Scout");
    ...
    private HBox createButtonPanel() {
        ...
        submitButton.setOnAction(e -> processSubmit());
    ...
    private void processAction(ActionEvent e) {
        ...
        // If this is the last field and enter key is pressed, automatically submit
        if (e.getSource() == dateStatusUpdatedField) {
            processSubmit();
        }
    }
    ...
    private void processSubmit() {
        ...
        scoutData.setProperty("Status", statusComboBox.getValue());
        scoutData.setProperty("DateStatusUpdated", dateStatusUpdatedField.getText());

        myModel.stateChangeRequest("AddScoutData", scoutData);
    }
    ...
    public void updateState(String key, Object value) {
        if (key.equals("AddScoutErrorMessage")) {
            displayErrorMessage((String) value);
        } else if (key.equals("AddScoutSuccessMessage")) {
            clearFields();
